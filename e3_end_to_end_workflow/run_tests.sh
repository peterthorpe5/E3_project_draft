...
if command -v snakemake >/dev/null 2>&1; then
    ...
    test -s test_runs/synthetic_e2e_v0_7_0/reports/e3_workflow_summary.html
    test -s test_runs/synthetic_e2e_v0_7_0/reports/report_manifest.json
    grep -q "SYNTHETIC TEST RUN" \
        test_runs/synthetic_e2e_v0_7_0/reports/e3_workflow_summary.html
